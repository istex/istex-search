        ...
        if (this.props.withPopover) {
            ...
            case 'cleaned': tooltipText = (
                <p>
                    ...
                    <br />
                    Fichier en texte brut, produit par ISTEX, dépourvu de mise en forme, image, tableau ou formule et qui contient uniquement le contenu textuel du corps du document (entre le résumé et les références bibliographiques).
                </p>
            );
                break;
            ...
            case 'grobidfulltext': tooltipText = (
                <p>
                    Version structurée du texte intégral obtenue à l'aide de l'outil <a href="https://enrichment-process.data.istex.fr/ark:/67375/R0H-2WXX0NK2-9" target="_blank" rel="noopener noreferrer">Grobid</a>.
                </p>
            );
                break;
